...
export function CashCounter(props: ICashCounterProps) {
  ...
  function setPenniesHandler(value: number | null, event: Event | undefined): void {
    if (event && value) { setPennies(value); }
    countCash();
  }

  function setNickelsHandler(value: number | null, event: Event | undefined): void {
    if (event && value) { setNickels(value); }
    countCash();
  }

  function setDimesHandler(value: number | null, event: Event | undefined): void {
    if (event && value) { setDimes(value); }
    countCash();
  }

  function setQuartersHandler(value: number | null, event: Event | undefined): void {
    if (event && value) { setQuarters(value); }
    countCash();
  }

  function setOnesHandler(value: number | null, event: Event | undefined): void {
    if (event && value) { setOnes(value); }
    countCash();
  }
  function setFivesHandler(value: number | null, event: Event | undefined): void {
    if (event && value) { setFives(value); }
    countCash();
  }
  function setTensHandler(value: number | null, event: Event | undefined): void {
    if (event && value) { setTens(value); }
    countCash();
  }
  function setTwentiesHandler(value: number | null, event: Event | undefined): void {
    if (event && value) { setTwenties(value); }
    countCash();
  }
  function setFiftiesHandler(value: number | null, event: Event | undefined): void {
    if (event && value) { setFifties(value); }
    countCash();
  }
  function setHundredsHandler(value: number | null, event: Event | undefined): void {
    if (event && value) { setHundreds(value); }
    countCash();
  }

  function countCash(): void {
    const newCashCount: MoneyBreakdown = new MoneyBreakdown(pennies, nickles, dimes, quarters, ones, fives, tens, twenties, fifties, hundreds);
